...
// Flag components
const IsraeliFlag = () => (
  <svg className="w-8 h-8 rounded-md shadow-sm" viewBox="0 0 640 480" xmlns="http://www.w3.org/2000/svg">
    <defs>
      <clipPath id="il-a">
    ...
    <g fillRule="evenodd" clipPath="url(#il-a)" transform="translate(82.1) scale(.94)">
      ...
      <path fill="#0038b8" d="M619.4 115.2H-112V48h731.4zm0 350.4H-112v-67.2h731.4zm-483-274h262.4l-131.2 231-131.2-231z"/>
      <path fill="#fff" d="M225.8 317.8l20.9 35.5 21.4-35.3-42.4-.2z"/>
      <path fill="#0038b8" d="m136.4 320 41.3-71.7h82.5l41.4 71.6-41.5 71.5H178zm28.6-57 28.4 48.5 57.4.2 28.8-48.7-28.5-48.2h-57.3l-28.8 48.2zm177.3-79.3 21-35.5 21.3 35.5-42.3.1z"/>
      ...
      <path fill="#0038b8" d="m135.4 254.5 42.2 73.5 45-73.3-87.2-.2zm175.2 0-42.2 73.5-45-73.3 87.2-.2z"/>
      <path fill="#fff" d="m267.3 192-28.3 48.5-57.5-.2-28.8-48.8 28.5-48.1h57.3l28.8 48.7z"/>
    </g>
  </svg>
);
    ...
    >
      ...
      >
        ...
        <div className="text-start">
          ...
          <p className={`font-semibold ${isHebrew ? "text-primary" : "text-foreground"}`} dir="rtl">
            אני רוצה ללמוד עברית
          </p>
          <p className="text-xs text-muted-foreground">I want to learn Hebrew</p>
        </div>
        {!isHebrew && (
          <svg 
      ...
      >
        ...
        <div className="text-start">
          ...
          <p className={`font-semibold ${isEnglish ? "text-primary" : "text-foreground"}`}>
            I want to learn English
          </p>
          <p className="text-xs text-muted-foreground" dir="rtl">אני רוצה ללמוד אנגלית</p>
        </div>
        {!isEnglish && (
          <svg 
            className="w-5 h-5 text-muted-foreground group-hover:text-primary transition-colors ms-2 rtl:rotate-180" 
